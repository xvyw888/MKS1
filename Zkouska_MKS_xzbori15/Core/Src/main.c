...
int main(void)
{
	...
	while (1)
	{
		...
		if (value > 9){
			if (state == clockwise){
				value = 0;
				// if initial value is 0 and we decrement this value as long as it's uint16_t it suddenly became 2^16 which is bigger than 5 and it's set to max BCD value
